...
import { Button, Card, Col, Input, Modal, Row, Tooltip, Typography, notification } from 'antd';
import React, { useEffect, useState } from 'react';
import { useNavigate, useParams } from 'react-router-dom';

import { Center } from '@/schemas/center.schema';
import { getCenterById, deleteCenter } from '@/services/api/center'; // Import deleteCenter API
